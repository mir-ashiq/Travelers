...
const EditGalleryPage = () => {
  ...
  const fetchGalleryItem = async () => {
    ...
    try {
      ...
      toast.error('An error occurred while loading the gallery item');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold mb-4">Gallery Item Details</h2>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Gulmarg Snow Peak"
