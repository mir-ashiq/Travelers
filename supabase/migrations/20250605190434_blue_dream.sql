/*
# Data Initialization for JKLG Travel Agency

1. New Data
  - Destinations with images and descriptions
  - Tour packages with complete details
  - Tour itineraries for each package
  - Gallery images from various locations
  - Testimonials from past customers
  - Admin users for the admin panel
  - Sample bookings for demonstration
  - Support tickets and messages
  - FAQs for customer reference
  - Blog posts with travel content
*/
